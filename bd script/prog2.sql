...
CREATE TABLE `carro` (
  ...
  `ano` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `carro` VALUES (3,'1983','popular','vw','fusca');
...
CREATE TABLE `cidade` (
  ...
  `populacao` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pais` (
  ...
  `nome` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `populacao` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pais` VALUES (5,'Europa','Dinamarca','90'),(6,'asia','Japao','39');
...
-- Dump completed on 2019-05-23 22:25:52
